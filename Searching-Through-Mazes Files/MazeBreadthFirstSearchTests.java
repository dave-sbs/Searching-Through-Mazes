 ...
 * CS 231
 * Project 7
 * MazeBreadthFirstSearchTests.java
 * 
 * Purpose: Tests MazeBreadthFirstSearch Class
 */
...
public class MazeBreadthFirstSearchTests {
    public static void main(String[] args) throws InterruptedException {
        Maze maze = new Maze(10, 10, 0);
        AbstractMazeSearch MBFS = new MazeBreadthFirstSearch(maze);
